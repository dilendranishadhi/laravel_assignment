...
@method('PUT')
     <div class="row">
        ...
        <div class="col-xs-12 col-sm-12 col-md-12">
            <div class="form-group">
                <strong>Phone:</strong>
                <input type="tel" name="phone" value ="{{ $employee->phone }}" class="form-control" placeholder="phone" pattern="[0-9]{10}">
            </div>
        </div>
        <div class="col-xs-12 col-sm-12 col-md-12">
            <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-12 col-md-12">
            <div class="form-group">
                ...
                <input type="text" name="company_id" value ="{{ $employee->company_id }}" class="form-control" placeholder="company_id">
            </div>
        </div>
